...
Modified in https://github.com/language-plus-molecules/LPM-24-Dataset
...
def evaluate(input_file, morgan_r, verbose=False):
    ...
    with open(osp.join(input_file)) as f:
        ...
        for n, line in enumerate(reader):
            try:
                ...
                bad_mols += 1
                outputs.append((line['description'], gt_m, None))
    ...
    return validity_score, maccs_sims_score, rdk_sims_score, morgan_sims_score, uniqueness_score
